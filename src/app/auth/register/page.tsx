  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        {/* Formulário de registro com efeito de vidro e gradiente */}
          ...
          <div className="relative bg-background/30 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 shadow-lg">
            ...
            <div className="mb-6">
              ...
              <div className="relative flex items-center justify-center my-4">
                ...
                <span className="relative px-2 bg-background/60 backdrop-blur-sm text-sm text-white/60">ou registre-se com email</span>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center mt-6">
                  ...
                  <label className="ml-2 text-sm text-white/70">
                    Eu aceito os <Link href="/terms" className="text-primary hover:text-accent transition-colors">Termos de Uso</Link> e <Link href="/privacy" className="text-primary hover:text-accent transition-colors">Política de Privacidade</Link>
                  </label>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group relative w-full mt-6 px-4 py-2.5 bg-primary/80 hover:bg-primary text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
